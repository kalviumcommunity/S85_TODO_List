    ...
    return (
        <div className="flex justify-center items-center min-h-screen bg-black text-white">
            <form className="p-6 bg-gray-900 shadow-lg rounded-lg" onSubmit={handleSubmit}>
                <h2 className="text-lg font-bold mb-4 text-green-400">Signup</h2>
                <input className="border p-2 w-full mb-2 bg-gray-800 text-white" type="text" placeholder="Name" value={name} onChange={(e) => setName(e.target.value)} required />
                ...
                <button className="bg-green-500 hover:bg-green-600 text-white px-4 py-2 rounded w-full" type="submit">Signup</button>
            </form>
        </div>
    );
}
